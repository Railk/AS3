/**
 * FOAF RDF PARSER/LINKEDDATA (CURRENTLY JAVASCRIPT TO BE PORTED TO AS3)
 * 
...
package railk.as3.data.parser
{
	...
	public class RDFItem
	{
		...
		private var RDF_NS="http://www.w3.org/1999/02/22-rdf-syntax-ns#";
		private var RDFS_NS="http://www.w3.org/2000/01/rdf-schema#";
		...
		this.setTriples = function(mytriples) {inTriples=mytriples;};
